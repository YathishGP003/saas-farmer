        ...
        <div className="space-y-8">
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border border-gray-200">
            ...
            <p className="mb-4 text-gray-800 font-medium">
              Our plant disease detection tool uses advanced image recognition
              to identify diseases in your crops and provide treatment
              recommendations.
            </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8 border border-gray-200">
              ...
              <div className="mt-8 pt-4 border-t-2 border-gray-200">
                <p className="text-sm text-gray-700 font-medium bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  <span className="font-bold">Note:</span> The diagnosis is
                  based on visual analysis and may require confirmation from an
                  agricultural expert. Always follow professional advice when
                  applying treatments to your crops.
                </p>
              </div>
            </div>
          )}
