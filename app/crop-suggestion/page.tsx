      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border border-gray-200">
          ...
          <p className="mb-4 text-gray-800 font-medium">
            Our crop suggestion tool uses agricultural expertise and knowledge
            of climate conditions to recommend the most suitable and profitable
            crops for your region and timeline.
          </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            ...
            <div className="space-y-6">
              {result.suggestedCrops.map((crop, index) => (
                <div
                  key={index}
                  className="border-2 border-gray-200 rounded-lg p-6 hover:border-green-200 hover:shadow-md transition-all duration-200"
                >
            ...
            <div className="mt-8 pt-4 border-t-2 border-gray-200">
              <p className="text-sm text-gray-700 font-medium bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                <span className="font-bold">Note:</span> Recommendations based
                on agricultural expertise and growing conditions. Actual results
                may vary based on local conditions, weather patterns, and
