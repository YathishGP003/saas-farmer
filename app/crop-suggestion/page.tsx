        ...
        <div className="space-y-8">
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border border-gray-200">
            ...
            <p className="mb-4 text-gray-800 font-medium">
              ...
              of climate conditions to recommend the most suitable and
              profitable crops for your region and timeline.
=======
...
<<<<<<< HEAD
              ...
              <div className="mt-8 pt-4 border-t-2 border-gray-200">
                <p className="text-sm text-gray-700 font-medium bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                  ...
                  on agricultural expertise and growing conditions. Actual
                  results may vary based on local conditions, weather patterns,
