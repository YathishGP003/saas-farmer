    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-20 bg-gradient-to-b from-green-700 to-green-500 text-white bg-opacity-80 bg-cover bg-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8">
            Get instant plant disease diagnosis, crop suggestions, and farming
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Our platform offers advanced tools to help farmers make
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-center mb-4 text-slate-700">
                Plant Disease Detection
              </h3>
              <p className="text-gray-600 mb-6">
                Upload an image of a diseased plant and get instant AI-powered
                diagnosis with treatment recommendations.
              </p>
              <div className="text-center">
                <Link
                  href="/plant-disease"
                  className="inline-block w-full py-3 px-4 bg-green-600 hover:bg-green-700 text-white rounded-md text-center"
                >
                  Upload Image
                </Link>
              </div>
            ...
            <div className="border rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Get personalized crop suggestions based on your location,
                season, and market forecasts.
              </p>
              <div className="text-center">
                <Link
                  href="/crop-suggestion"
            ...
            <div className="border rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Chat with our AI farming assistant to get quick answers to all
                your agricultural questions and expert advice.
              </p>
              <div className="text-center">
                <Link
                  href="/chatbot"
      ...
      <section className="py-20 bg-green-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl mb-8">
            Join thousands of farmers using AgriLearnNetwork to improve crop
            yields, prevent diseases, and optimize their farming operations.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            {!isLoggedIn && (
            ...
            <Link
              href="/plant-disease"
              className="px-6 py-3 border border-white hover:bg-green-600 rounded-md font-medium"
            >
