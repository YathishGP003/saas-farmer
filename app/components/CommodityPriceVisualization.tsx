...
export default function CommodityPriceVisualization() {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold mb-4 text-slate-600">Commodity Price Trends</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <h3 className="text-lg font-medium mb-4 text-slate-600">
      ...
      <div className="mt-4 text-sm text-gray-600 italic">
        Source: Real-time market data. Last updated:{" "}
